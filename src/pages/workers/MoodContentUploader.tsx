...
export default function MoodContentUploader() {
    ...
    const handleSubmit = async (isDraft = false) => {
        ...
        try {
            // Parallel Upload logic for speed
            setProgress(30);
            ...
            const workerEmail = auth.currentUser?.email || "unknown_worker";
            ...
            setTimeout(() => navigate("/workers/dashboard"), 1500);
        ...
        <div className="min-h-screen bg-[#050505] text-white font-sans">
            ...
            <nav className="h-20 border-b border-white/5 bg-black/40 backdrop-blur-xl flex items-center justify-between px-8 sticky top-0 z-50">
                <div className="flex items-center gap-6">
                    <button onClick={() => navigate("/workers/dashboard")} className="p-2 hover:bg-white/5 rounded-full transition-colors text-white/40 hover:text-white">
                        <ArrowLeft className="w-5 h-5" />
                    </button>
                    <div>
                        <Logo className="h-5 mb-1" />
                        <p className="text-[10px] uppercase tracking-[0.3em] text-[#e9c49a] font-black">Mood Content Uploader</p>
                    </div>
                </div>
                        ...
                        {uploading && (
                            ...
                            >
                                <div className="flex justify-between items-center text-[10px] uppercase tracking-widest font-black text-[#e9c49a]">
                                    <span>Transmitting Artifact Frequency...</span>
                                    <span>{progress}%</span>
                                </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 p-10 rounded-[2.5rem] bg-white/[0.01] border border-white/5">
                        ...
                        <div className="space-y-4">
                            ...
                            <select
                                ...
                                className="w-full h-12 bg-[#050505] border border-white/10 rounded-xl px-4 text-xs outline-none text-white/60 appearance-none"
                            >
                ...
                <div className="lg:col-span-4 space-y-8">
                    <div className="sticky top-32 space-y-6">
                        <div className="flex items-center gap-3 text-[10px] uppercase tracking-[0.4em] text-[#e9c49a] font-black">
                            <Eye className="w-4 h-4" /> Live Mood Preview
                        </div>
